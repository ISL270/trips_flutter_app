...
class $AssetsImagesGen {
  ...
  AssetGenImage get fullLogo => const AssetGenImage('assets/images/full_logo.png');

  /// File path: assets/images/small_logo.png
  AssetGenImage get smallLogo => const AssetGenImage('assets/images/small_logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [fullLogo, smallLogo];
}
...
class $AssetsSvgsGen {
  ...
  SvgGenImage get chevronDown => const SvgGenImage('assets/svgs/chevron_down.svg');

  /// File path: assets/svgs/dots_horizontal.svg
  SvgGenImage get dotsHorizontal => const SvgGenImage('assets/svgs/dots_horizontal.svg');
...
class Assets {
  ...
  static const String tripsMock = 'trips_mock.json';

  /// List of all assets
  static List<String> get values => [tripsMock];
}
